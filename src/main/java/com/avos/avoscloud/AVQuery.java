 ...
 * finding all objects that match a query through the find method, using a FindCallback.
 ...
 * get method, using a GetCallback. For example, this sample code fetches an object of
